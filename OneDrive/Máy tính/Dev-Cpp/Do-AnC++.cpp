...
SinhVien dsSV[100];
//Ham tach ten 
string tachTen(string fullName) {
...
// Ham sap xep
void sapXepDanhSachSinhVien(SinhVien dsSV[], string firstName[], int n) {
    int click;
...
void Ten(SinhVien dsSV[], int n, string firstName[]) {
    for (int i = 0; i < n; i++) {
        firstName[i] = tachTen(dsSV[i].tenSV);
    }
}
int main() {
    int n = 0;
    ...
    do {
        ...
        case 5:
         ...
         cout<<"Ban da xoa thong tin cua sinh vien  thanh cong !!"<<endl; 
            
            break;
        case 6:

            sapXepDanhSachSinhVien(dsSV, firstName, n);
